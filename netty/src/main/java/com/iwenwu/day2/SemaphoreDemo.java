 ...
 * @Description: 线程池与信号量的联合使用
 */
public class SemaphoreDemo {
    private static final Semaphore SEMAPHORE =new Semaphore(3);
    private static final ThreadPoolExecutor THREAD_POOL =new ThreadPoolExecutor(5,10,60, TimeUnit.SECONDS,new LinkedBlockingQueue<Runnable>());
